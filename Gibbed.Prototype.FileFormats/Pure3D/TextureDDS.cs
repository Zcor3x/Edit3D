...
using System.IO;
using Gibbed.IO;
using Gibbed.Prototype.FileFormats.G1zm0;
...
namespace Gibbed.Prototype.FileFormats.Pure3D
{
    ...
    public class TextureDDS : BaseNode
    {
        ...
        public override object Preview()
        {
            ...
            try
            {
#warning this is an hacked function by G1zm0!
                //var dds = new Squish.DDSFile();
                //dds.Deserialize(memory);
                //return dds.Image();


                DDSImage _hack = new DDSImage(memory.ToArray());



                return _hack.images[0];
            }
